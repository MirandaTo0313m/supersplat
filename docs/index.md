...
> **Note (personal):** On a trackpad, two-finger scroll maps to the scroll wheel for dollying, and two-finger drag can be used to pan. This works well on macOS with a Magic Trackpad.
